...
def create_fundamental_scatter_plot(data1, data2, st_list, data1_name, data2_name):
    ...
    for asset in st_list:
        ...
        # 레이아웃 설정
        fig.update_layout(
            title="Fundamental Anaysis",
            xaxis_title=f"{data1_name} 3개월 증가율",
            yaxis_title=f"{data2_name} 3개월 증가율",
...
def main():
    ...
    data1_name = 'Fwd EPS 3m Chg'
    data2_name = 'Fwd FCF 3m Chg'
    data3_name = 'Fwd Sales 3m Chg'

    create_fundamental_scatter_plot(us_eps_fwd_3m, index_fcf_fwd_3m, st_list, data1_name, data2_name)
    create_fundamental_scatter_plot(us_eps_fwd_3m, us_sales_fwd_3m, st_list, data1_name, data3_name)
